...
+ "<td> <input type='text' readonly name = 'anum' value='"+rs.getInt("anum")+"'"
+ "</tr>"
+ "<tr> "
+ "<td> <label> Account Name = </label> </td>"
+ "<td> <input type='text' name = 'aname' value='"+rs.getString("aname")+"'"
+ "</tr>"
+ "<tr> "
+ "<td> <label> Balance = </label> </td>"
+ "<td> <input type='text' name='abal' readonly value='"+rs.getInt("abal")+"'"
+ "</tr>"
+ "<tr>"
...
pw.print("<h3 align='center'>No Such Record - Try Again</h3>");
 request.getRequestDispatcher("/nameupdate.html").include(request,
response);
}
}
catch(Exception e)
